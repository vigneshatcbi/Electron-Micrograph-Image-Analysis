...
NUM_IMAGES = 9;
SPLITINFO.TYPE = 'nonoverlap'; SPLITINFO.N = 131;
FILTERINFO.F = makeLMfilters; FILTERINFO.ID = 2;
for syniter = 1:1:2
...
save('curr_features\textons.mat', 'featbag');

% PARSE FEATURES
PARSER.NUM_IMAGES = NUM_IMAGES; PARSER.TRAIN_NUMBER = round(.7*NUM_IMAGES); PARSER.TEST_NUMBER = NUM_IMAGES - PARSER.TRAIN_NUMBER;
PARSER.filename = 'textons.mat'; PARSER.feat_dir = [pwd '\curr_features\']; PARSER.stackup = false;
